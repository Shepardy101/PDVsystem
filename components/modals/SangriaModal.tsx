    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Sangria de Emergência">
      <div className="space-y-6 animate-in zoom-in-95 duration-200">
        ...
        <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/5">
          ...
          <Button className="py-4 uppercase text-[10px] font-bold tracking-widest shadow-red-500/10 bg-red-500/10 text-red-400 border-red-500/30 hover:bg-red-500/20" icon={<Check size={18}/>} onClick={handleSubmit} disabled={loading || !amount || !category || !description}>Executar Sangria</Button>
        </div>
      </div>
    </Modal>
  );
