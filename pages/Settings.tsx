...
const Settings: React.FC = () => {
  ...
  useEffect(() => {
    const mockEvents = [
  "Inicializando núcleo de serviços… OK",
  "Modulo de autenticação carregado em 148ms",
  "Sessão segura iniciada para operador LOCAL",
  "Handshake TLS renovado automaticamente",
  "Fila de tarefas assíncronas sincronizada (12 itens)",
  "Cluster de dados respondeu em 11ms",
  "Carga média do servidor estável: 32%",
  "Atualização de métricas enviada ao painel principal",
  "Módulo de relatórios iniciado",
  "Revalidação do token de API concluída",
  "Cache de produtos atualizado (384 registros)",
  "Conexão com servidor de estoque restabelecida",
  "Sincronização incremental realizada em 2.4s",
  "Ping externo: 18ms (estável)",
  "Sessões ativas: 42",
  "Pipeline de mensagens limpo (0 pendências)",
  "Monitor de falhas reinicializou automaticamente",
  "Registro de venda enviado ao barramento principal",
  "Tabela de sessões reindexada",
  "Atualização silenciosa aplicada (versão 1.4.8)",
  "Nova instância de cálculo iniciada",
  "Log de compressão criado (nível 4)",
  "Limite de conexão simultânea dentro do normal",
  "Processo de reconciliação de estoque iniciado",
  "Rotina de limpeza semanal agendada",
  "Integração externa respondeu com status 200",
  "Dados de latência armazenados para análise",
  "Fila de impressão vazia",
  "Backup rápido finalizado (6.4MB)",
  "Novo índice criado para tabela de auditoria",
  "Revalidação da assinatura digital concluída",
  "Iniciada transmissão de telemetria",
  "Carga de CPU reduziu para 27%",
  "Cluster secundário ativado",
  "Evento de sincronização concluído com sucesso",
  "Tabela de logs rotacionada",
  "Rede interna estabilizada após pico de uso",
  "Thread auxiliar iniciada",
  "Verificação de integridade finalizada (OK)",
  "Registro enviado ao buffer de eventos",
  "Histórico de comandos atualizado",
  "Processo de compensação de dados concluído",
  "Inicialização automática do módulo OCR concluída",
  "Atualização de inventário recebida",
  "Conexão persistente renovada",
  "Fluxo de pedidos normalizado",
  "Job de compressão iniciado",
  "Guardião de processos sinalizou tudo OK",
  "Pipeline de auditoria limpo",
  "Cache de sessão reconstruído",
  "Medição de carga distribuída atualizada",
  "Controle de versão sincronizado com servidor mestre",
  "Conexão WebSocket restabelecida",
  "Rotina anti-queda ativada",
  "Leitura de sensores internos estável",
  "Fila de reprocessamento vazia",
  "Mapa de rotas recompilado",
  "Rede criptografada revalidada",
  "Exportador JSON gerou novo lote",
  "Ciclo de heartbeat confirmado",
  "Latência mínima atingida: 9ms",
  "Filtro de pacotes ajustado automaticamente",
  "Verificação cruzada de estoque finalizada",
  "Sincronização com servidor remoto concluída",
  "Tabela de configurações ajustada",
  "Serviço de indexação está ativo",
  "Entrada de operador registrada",
  "Tarefa recorrente executada com sucesso",
  "Mapeamento de dispositivos finalizado",
  "Conselho de diagnóstico: nenhum alerta",
  "Sistema detectou operação incomum (tratada)",
  "Fila de tarefas enviou 3 pacotes pendentes",
  "Análise preditiva atualizada",
  "Monitor de uso de memória estável: 41%",
  "Nova credencial registrada",
  "Sincronização de área executada",
  "Dados do operador transmitidos para o cluster",
  "Monitoração de rede ativou fallback temporário",
  "Carregamento de imagens otimizado",
  "Buffer de mensagens reduzido em 22%",
  "Escalonador iniciou novo ciclo",
  "Serviço de streaming interno está estável",
  "Compressão de logs concluída",
  "Repositório secundário atualizado",
  "Escaneamento de QR registrado",
  "Evento de alta prioridade tratado",
  "Rastreamento interno sincronizado",
  "Desfragmentação lógica finalizada",
  "Relatório analítico enviado",
  "API Externa respondeu com 128ms",
  "Fila de integração esvaziada",
  "Pool de conexões renovado",
  "Heartbeat duplo confirmado",
  "Módulo de notificações enviou 4 alertas",
  "Configuração dinâmica revalidada",
  "Thread de expiração reativada",
  "Tabelas críticas protegidas",
  "Sistema em modo estável",
  "Ciclo de verificação automática concluído",
  "Camada de serviços respondeu em 12ms",
  "Atividade geral acima da média — normalizada",
  "Dados transmitidos ao nó principal",
  "Captura de métricas encerrada",
  "Monitor de integridade relatou 0 falhas"
];
